...
import com.simple.middleman.lanmitm.service.ArpService;
import com.simple.middleman.lanmitm.service.HijackService;
import com.simple.middleman.lanmitm.service.SnifferService;
import com.simple.middleman.lanmitm.ui.AboutActivity;
import com.simple.middleman.lanmitm.ui.BrowserActivity;
import com.simple.middleman.lanmitm.ui.HijackHistory;
import com.simple.middleman.lanmitm.ui.HostsActivity;
import com.simple.middleman.lanmitm.ui.HttpActivity;
import com.simple.middleman.lanmitm.util.NetworkUtils;
import com.simple.middleman.lanmitm.util.ShellUtils;
import com.simple.middleman.lanmitm.widget.RadioDialog;
import com.simple.middleman.lanmitm.widget.YesOrNoDialog;
...
public class MainActivity extends ActionBarActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!ShellUtils.checkRootPermission()) {
			...
			ShellUtils.CommandResult cr = ShellUtils.execCommand("which killall", true, true, true);
			if (cr.result != 0) {
				YesOrNoDialog.Builder builder = new YesOrNoDialog.Builder(this);
