package com.simple.middleman.fi.iki.elonen;
...
import com.simple.middleman.lanmitm.service.HttpService;
...
public class SimpleWebServer extends NanoHTTPD {
	...
	public Response serve(IHTTPSession session) {
		...
		Intent intent = new Intent(HttpService.SERVER_LOG_CHANGE_INTENT);
		StringBuilder serverLog = new StringBuilder();
		serverLog.append(session.getMethod() + " " + uri + " \n");
		...
		while (e.hasNext()) {
			...
			System.out.println("  PARAMS: '" + value + "' = '"
					+ parms.get(value) + "'");
			serverLog.append("  PARAMS: '" + value + "' = '" + parms.get(value)
					+ "'\n");
		}
		AppContext.getServerLog().append(serverLog.toString());
